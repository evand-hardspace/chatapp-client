...
@Composable
internal fun PaginationScrollListener(
        ...
        snapshotFlow {
            ...
            PaginationScrollState(
                ...
                isEligible = remainingItems != null &&
                        remainingItems <= FetchDistance &&
                        isPaginationLoading.not() &&
                        isEndReached.not()
            )
        }
...
private const val FetchDistance = 5

internal data class PaginationScrollState(
